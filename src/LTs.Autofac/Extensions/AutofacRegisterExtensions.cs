...
namespace LTs.Autofac.Extensions;
...
{
    /// <summary>
    ///     Register a type with Autofac simplifying the process.
    /// </summary>
    ...
    /// <returns>
    ///     The
    ///     <see cref="IRegistrationBuilder{TImplementation, ConcreteReflectionActivatorData, SingleRegistrationStyle}" /> for
    ///     the registered type.
    /// </returns>
    [ UsedImplicitly ]
    public static IRegistrationBuilder<TImplementation, ConcreteReflectionActivatorData, SingleRegistrationStyle>
        RegisterType<TInterface, TImplementation>( this ContainerBuilder builder )
        where TImplementation : notnull
        where TInterface : notnull
    {
        var regBuilder = builder.RegisterType<TImplementation>().As<TInterface>();
